...
&emsp;&emsp;Fine-tuning:构建了特定样本的大模型微调系统：在云端Linux系统上高效微调Llama模型；设计自监督数据增强机制，基于特定风格自动生成高质量训练样本；开发字词敏感的提示工程，通过Few-shot示例和角色扮演引导模型掌握五言绝句创作规范；实现两阶段课程学习流水线，显著提升模型在指定风格任务完成度。
